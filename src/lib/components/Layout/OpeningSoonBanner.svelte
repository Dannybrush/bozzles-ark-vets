    ...
    <div class="main-content" class:animate={mounted}>
      ...
      <div class="main-announcement">
        <div class="announcement-line">
          <span class="exciting-text">Something</span>
          <span class="amazing-text">Amazing</span>
        </div>
        <div class="announcement-line secondary">
          <span class="coming-text">is Coming to</span>
        </div>
        <div class="announcement-line tertiary">
          <span class="location-highlight">Barwell!</span>
        </div>
      </div>
