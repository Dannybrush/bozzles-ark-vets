...
export const PriceListData = {
    ...
    diagnostics: {
        ...
        icon: "🩸",
        items: [
            { name: "In-house Blood Test", price: "£65", duration: "", note: "Results same day" },
            { name: "External Laboratory Tests", price: "From £45", duration: "", note: "Results 2-3 days" },
            { name: "X-ray (Single View)", price: "£95", duration: "", note: "" },
            { name: "X-ray (Two Views)", price: "£145", duration: "", note: "" },
            { name: "Ultrasound Scan", price: "From £185", duration: "", note: "" },
            { name: "CT Scan", price: "From £495", duration: "", note: "Referral basis" },
            { name: "Urinalysis", price: "£35", duration: "", note: "" },
            { name: "Faecal Analysis", price: "£28", duration: "", note: "" }
        ]
    ...
    additional: {
        ...
        icon: "📝",
        items: [
            { name: "Animal Health Certificate", price: "£75", duration: "", note: "Includes documentation, EU countries ONLY" },
